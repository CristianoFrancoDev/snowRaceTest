...
//singleton
public class Dao_Impianti implements DAO<Impianto>
{
    ...
    @Override
    public boolean insert(Impianto impianto)
    {
    ...
    @Override
    public boolean update(Impianto impianto)
    {
        PreparedStatement statement;
        boolean response = true;
